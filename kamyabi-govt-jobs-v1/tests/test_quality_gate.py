...
def test_good_record_publishes():
    j={"job_id":"x","title":"Test","organization":"Org","record_type":"recruitment","notification_url":"https://example.com/a.pdf","data_quality_score":80,"discovery_score":90,"publication_score":80,"application_end":"2099-12-31"}
    current,changes,review,pub=merge_jobs([], [j], "2026-08-29T00:00:00+00:00")
